<div id="fixed_left_sidebar" class="bg-warning text-white">
    ...
    <div class="border-bottom">
        ...
        <div id="page_links" class="list-unstyled collapse">
            ...
            <a href="#"><i class="fas fa-users"></i> Executives</a>
        </div>
    </div>

    <a id="usersPage" class="d-block side-link pl-2 pt-3 pb-3" href="users.php"><i class="fas fa-user"></i> Users</a>
